...
[Concord](concord.io) in it's current implementation does something different,
...
## 5. [Kyle Kingsbury](Aphyr.com) has a cruel apparatus - Empirical failures of datastores FTW
